...
const Products = (props: any) => {
  ...
  const columns = [
    ...
    { title: L(LocalizationKeys.ERP_LblApp.key), dataIndex: 'appName', sorter: true, key: 'appName', width: 150, render: (text: string) => <div>{text}</div> },
