...
const CustomDataRepeater = (props: any) => {
    ...
    const { currencyList, validations, lockRow, removeRow, removeIcon, dataRow, formRef, revertExchange, viewMode } = props;
            ...
            {!viewMode && <CustomRow gutter={[16, 16]} className="data-body">
                ...
                <CustomCol span={5}>
                    ...
                    <CustomNumberInput
                        ...
                        dynamicFormula={formula.fromAmount} formRef={formRef} disable={!dataItemRow.isEditable} />
