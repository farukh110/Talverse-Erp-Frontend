...
const FormView = (props: any) => {
    ...
    const { formFields, formData, formMode, popupHeading } = props;
    ...
    if (formFields && formFields.formFields && formFields.formFields.length > 0) {
    ...
    return (<CustomModal {...modalOptions}>
        ...
        <CustomForm formMode={formMode} onSubmit={onCreate} onCancel={onCancel} {...formFields}></CustomForm>
